...
const router = (app) => {
  ...
  app.get('/getNameC', controllers.getNameC);
  app.get('/findByNameC', controllers.searchNameC);
  app.get('/getNameD', controllers.getNameD);
  app.get('/findByNameD', controllers.searchNameD);
  ...
  app.post('/setNameC', controllers.setNameC);

  // When someone POSTS to /updateLast, call controllers.updateLast
  app.post('/updateLastC', controllers.updateLastC);

  app.post('/setNameD', controllers.setNameD);

  // When someone POSTS to /updateLast, call controllers.updateLast
  app.post('/updateLastD', controllers.updateLastD);
};
